...
- [ ] 1. Foundation: ECharts アセットの self-host 配信
...
- [ ] 3. サーバー描画を ECharts option へ切替（統合: ViewModel + フラグメント templ + handler）
...
- [ ] 5. クライアント ECharts 初期化（App.templ グローバル）
