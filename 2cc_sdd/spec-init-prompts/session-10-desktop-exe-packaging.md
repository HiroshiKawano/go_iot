...
**3. ブラウザ自動オープン（pure-Go 維持）— 【オーナー決定 2026-06-08】初版のデスクトップ UX はこれのみ:**
...
- systray 常駐（デスクトップ感の補強）は **【オーナー決定 2026-06-08】初版スコープ外**（将来拡張。cgo 無し選択肢あり）。初版のデスクトップ UX は「ブラウザ自動オープンのみ」で確定。
